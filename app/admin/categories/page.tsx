    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-[#45cab4] hover:bg-[#37b19d] text-black text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-sm active:scale-95 cursor-pointer"
        >
      ...
      {/* Search Bar */}
      <div className="flex items-center gap-4 p-3.5 sm:p-4 rounded-2xl bg-white border border-gray-200 shadow-sm">
      ...
      <div className="rounded-2xl bg-white border border-gray-200 shadow-sm overflow-hidden">
        {loading ? (
          <div className="py-20 text-center">
            <LoadingSpinner size="lg" text="Loading catalog categories..." />
          </div>
        ) : (
          <>
              ...
              {filteredCategories.map((cat) => (
                <div key={cat.id} className="p-3.5 flex items-center justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <span className="font-mono text-[11px] text-gray-500 block truncate">
                      {cat.slug}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <span className="px-2.5 py-1 rounded-full bg-[#45cab4]/15 text-[#2b9685] font-bold text-[10px] border border-[#45cab4]/30">
                      {cat.count || 0} items
                    </span>
                    <button
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-sm">
          <div className="relative w-full max-w-md bg-white border border-gray-200 rounded-2xl p-5 sm:p-8 shadow-2xl space-y-4">
            <button
