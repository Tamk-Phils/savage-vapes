...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-2xl bg-white border border-gray-200 shadow-sm">
      ...
      <div className="rounded-2xl bg-white border border-gray-200 shadow-sm overflow-hidden">
        {loading ? (
          <div className="py-20 text-center">
            <LoadingSpinner size="lg" text="Loading customer orders..." />
          </div>
          ...
          <>
            {/* Mobile Touch-Friendly Order Cards (< sm) */}
            <div className="block sm:hidden divide-y divide-gray-100">
              {filteredOrders.map((ord: any) => (
                <div key={ord.id} className="p-3.5 space-y-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-gray-500 mt-0.5">
                      Destination: <span className="font-semibold text-gray-700">{ord.shippingAddress?.suburb || 'Australia'}, {ord.shippingAddress?.state || 'AU'}</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between pt-1 border-t border-gray-50">
                    <div>
                      ...
                      <span className="text-[10px] uppercase font-bold text-gray-400">
                        {ord.paymentMethod} • {ord.items?.reduce((acc: number, item: any) => acc + (item.quantity || 1), 0)} items
                      </span>
                    </div>
                    <button
                      onClick={() => {
      ...
      {selectedOrder && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-sm">
          <div className="relative w-full max-w-2xl bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 sm:p-8 max-h-[92vh] overflow-y-auto shadow-2xl space-y-4 sm:space-y-6">
            <button
            ...
            <div className="p-3.5 sm:p-4 rounded-xl bg-gray-50 border border-gray-200 space-y-3">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3">
                <select
                  ...
                  className="bg-white border border-gray-300 text-xs font-bold text-gray-900 rounded-xl px-3 py-2.5 focus:border-[#45cab4] focus:outline-none cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-[#45cab4] text-black text-xs font-bold uppercase tracking-wider hover:bg-[#37b19d] cursor-pointer text-center"
                >
                  Save Tracking
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="p-3.5 sm:p-4 rounded-xl bg-gray-50 border border-gray-200 space-y-2 text-xs">
                ...
                <p className="text-gray-600 break-all">{selectedOrder.customerEmail}</p>
            ...
            <div className="space-y-3">
              ...
              <div className="divide-y divide-gray-100 rounded-xl bg-gray-50 border border-gray-200 p-3 sm:p-4">
                  ...
                  <div key={idx} className="py-2.5 first:pt-0 last:pb-0 flex items-center justify-between gap-4 text-xs">
                    <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <span className="font-semibold text-gray-900 block truncate">{item.productName}</span>
                        {item.selectedFlavor && (
                          <span className="text-gray-500 text-[11px] block truncate">Flavor: {item.selectedFlavor}</span>
                        )}
            ...
            <div className="pt-2 border-t border-gray-200 flex justify-between items-baseline text-sm">
              ...
              <span className="text-xl sm:text-2xl font-black text-[#2b9685] font-display">
